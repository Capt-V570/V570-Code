...
# license plate for your car, with your choice of letters and numbers instead of random ones.
...
def is_valid(s):
    ...
    if not re.match(r"^[A-Z]{2,4}[A-Z1-9]{2,3}?$|^H$|^CS50$", s):
        return False

    if not s[2] != "0" and s[4] != "P":
        return False
